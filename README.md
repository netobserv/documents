...
### Repositories
* [netobserv-operator](https://github.com/netobserv/netobserv-operator)
    ...
    * [netobserv-plugin](https://github.com/netobserv/netobserv-web-console):
...
### Get started
The easiest way to get started is to use the [NetObserv Operator](https://github.com/netobserv/netobserv-operator) that will deploy all the components for you. It is available via [OLM](https://operatorhub.io/operator/netobserv-operator).

You can either:
- [Deploy an existing image](https://github.com/netobserv/netobserv-operator#deploy-an-existing-image)
- [Build from sources](https://github.com/netobserv/netobserv-operator#build--push--deploy)
